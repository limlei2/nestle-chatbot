    ...
    rewrite_prompt = [
        {
            ...
            "content": (
                ...
                "2. The vector database — for general or lifestyle-related questions that could benefit from semantic search, including queries about Nestlé products, food ideas, holidays, or vague recipe prompts (even if Nestlé is not explicitly mentioned).\n"
                "3. \"reply\" – only for clearly out-of-scope queries that are not related to recipes, food, or lifestyle (e.g., 'Who are you?', 'What can you do?', or non-recipe-related personal questions).\n\n"
                "First, classify the query as either 'vector', 'graph' or 'reply' depending on its structure and specificity. "
                "Then, rewrite the query to make it more relevant and descriptive for retrieval. If target is 'reply', this should be a direct response to the user's question, while still maintaining the role of a AI assistant of MadeWithNestle.ca\n\n"
